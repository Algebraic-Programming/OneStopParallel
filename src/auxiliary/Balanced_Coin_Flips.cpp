...
Thue_Morse_Sequence::Thue_Morse_Sequence() {
    next = randInt(1024);
    sequence.emplace_back(false);
}

Thue_Morse_Sequence::Thue_Morse_Sequence(long unsigned int shift) : next(shift) {
    sequence.emplace_back(false);
}

bool Thue_Morse_Sequence::get_flip() {
...
bool Biased_Random_with_side_bias::get_flip() {
