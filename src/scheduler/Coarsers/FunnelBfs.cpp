...
bool FunnelBfs::isCompatibleNodeType(const VertexType& new_node, const VertexType& old_node, const BspInstance& instance) {
...
RETURN_STATUS FunnelBfs::run_contractions() {
