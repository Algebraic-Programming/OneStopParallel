...
void CoptFullScheduler::setupVariablesConstraintsObjective(const BspInstance &instance, Model &model) {
...
void CoptFullScheduler::loadInitialSchedule(Model &model) {
