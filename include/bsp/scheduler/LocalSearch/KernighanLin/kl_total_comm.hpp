...
class kl_total_comm : public kl_total<Graph_t> {
            ...
            if (current_proc == new_proc) {
                ...
                for (const auto &target :
                    ...
                    if (target_proc == current_proc) {
                        ...
                        const double gain = (double)kl_total<Graph_t>::current_schedule.instance->getComputationalDag()
                                                .vertex_comm_weight(node) *
                                            kl_total<Graph_t>::current_schedule.instance->communicationCosts(
                        ...
                        const double gain =
                            (double)(kl_total<Graph_t>::current_schedule.instance->communicationCosts(new_proc,
                                                                                                      target_proc) -
                                     kl_total<Graph_t>::current_schedule.instance->communicationCosts(current_proc,
                                                                                                      target_proc)) *
                            kl_total<Graph_t>::current_schedule.instance->getComputationalDag().vertex_comm_weight(
                                node) *
                            kl_total<Graph_t>::current_schedule.comm_multiplier;
                    ...
                    if (target_proc == current_proc) {
                        ...
                        const double gain =
                            (double)(kl_total<Graph_t>::current_schedule.instance->communicationCosts(new_proc,
                                     ...
                                     kl_total<Graph_t>::current_schedule.instance->communicationCosts(current_proc,
                                                                                                      target_proc)) *
                            kl_total<Graph_t>::current_schedule.instance->getComputationalDag().edge_comm_weight(
                                out_edge) *
                            kl_total<Graph_t>::current_schedule.comm_multiplier;
        ...
        for (const auto &edge : kl_total<Graph_t>::current_schedule.instance->getComputationalDag().edges()) {
            ...
            if (source_proc != target_proc) {
                ...
                if (kl_total<Graph_t>::current_schedule.use_node_communication_costs) {
                    ...
                    comm_costs +=
                        kl_total<Graph_t>::current_schedule.instance->getComputationalDag().edge_comm_weight(edge) *
                        kl_total<Graph_t>::current_schedule.instance->communicationCosts(source_proc, target_proc);
                }
            }
        }
  ...
  public:
    kl_total_comm(bool use_node_communication_costs_ = false) : kl_total<Graph_t>(use_node_communication_costs_) {}
...
class kl_total_comm_test : public kl_total_comm<Graph_t> {
  ...
  public:
    kl_total_comm_test() : kl_total_comm<Graph_t>() {}
