...
class kl_total_comm : public kl_total<Graph_t, MemoryConstraint_t, use_node_communication_costs_arg> {
  ...
  protected:
            ...
            if (current_proc == new_proc) {
                ...
                for (const auto &target :
                    ...
                    if ((current_step + 1 ==
                        ...
                        kl_total<Graph_t, MemoryConstraint_t,use_node_communication_costs_arg>::node_gains[node][current_proc][0] +=
                            (double)kl_total<Graph_t, MemoryConstraint_t,use_node_communication_costs_arg>::current_schedule.instance->getComputationalDag()
                ...
                for (const auto &target :
                    ...
                    if (target_proc == current_proc) {
                        ...
                        const double gain = (double)kl_total<Graph_t, MemoryConstraint_t,use_node_communication_costs_arg>::current_schedule.instance->getComputationalDag()
                                                .vertex_comm_weight(node) *
                        ...
                        const double gain =
                            (double)(kl_total<Graph_t, MemoryConstraint_t,use_node_communication_costs_arg>::current_schedule.instance->communicationCosts(new_proc,
                                                                                                      target_proc) -
    ...
    virtual double compute_current_costs() override {
        ...
        kl_total<Graph_t, MemoryConstraint_t,use_node_communication_costs_arg>::current_schedule.current_cost =
            ...
            ((double)kl_total<Graph_t, MemoryConstraint_t,use_node_communication_costs_arg>::current_schedule.num_steps() - 1) *
  ...
  public:
    kl_total_comm() : kl_total<Graph_t, MemoryConstraint_t, use_node_communication_costs_arg>() {}
...
class kl_total_comm_test : public kl_total_comm<Graph_t, MemoryConstraint_t, use_node_communication_costs_arg> {
  ...
  public:
    ...
    kl_current_schedule_total<Graph_t, MemoryConstraint_t, use_node_communication_costs_arg> &get_current_schedule() {
        return kl_total<Graph_t, MemoryConstraint_t, use_node_communication_costs_arg>::current_schedule;
    }
    ...
    void initialize_gain_heap_test(const std::unordered_set<vertex_idx_t<Graph_t>> &nodes, double reward_ = 0.0,
        ...
        kl_total<Graph_t, MemoryConstraint_t, use_node_communication_costs_arg>::initialize_gain_heap(nodes);
    }
