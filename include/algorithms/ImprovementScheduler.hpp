 ...
 * @brief Abstract base class for improvement scheduling algorithms.
 *
 * The ImprovementScheduler class provides a common interface for improvement scheduling algorithms.
 * Subclasses of this class can implement specific improvement algorithms by overriding the virtual methods.
 */
class ImprovementScheduler {
