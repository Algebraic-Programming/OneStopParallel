...
/**
 * @class Scheduler
 * @brief Abstract base class for scheduling algorithms.
 * 
 * The Scheduler class provides a common interface for scheduling algorithms in the BSP scheduling system.
...
class Scheduler {
    ...
    public:
        ...
        /**
         * @brief Compute a schedule for the given BSP instance.
