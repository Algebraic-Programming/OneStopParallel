...
struct OldGrowLocalAutoCoresParallelParams {
...
/**
 * @brief The OldGrowLocalAutoCoresParallel class represents a scheduler that uses a greedy algorithm to compute
 ...
 * The GetScheduleName() method returns the name of the schedule, which is "OldGrowLocalAutoCoresParallel" in this
 * case.
 */
template <typename GraphT>
class OldGrowLocalAutoCoresParallel : public Scheduler<GraphT> {
  ...
  private:
    ...
    OldGrowLocalAutoCoresParallelParams<VertexIdxT<GraphT>, VWorkwT<GraphT>> params_;

  public:
    /**
     * @brief Default constructor for OldGrowLocalAutoCoresParallel.
     */
    OldGrowLocalAutoCoresParallel(OldGrowLocalAutoCoresParallelParams<VertexIdxT<GraphT>, VWorkwT<GraphT>> params
                               = OldGrowLocalAutoCoresParallelParams<VertexIdxT<GraphT>, VWorkwT<GraphT>>())
        : params_(params) {}

    /**
     * @brief Default destructor for OldGrowLocalAutoCoresParallel.
     */
    virtual ~OldGrowLocalAutoCoresParallel() = default;
...
#pragma omp for schedule(static, 1)
     ...
     *
     * This method returns the name of the schedule, which is "OldGrowLocalAutoCoresParallel" in this case.
     *
     * @return The name of the schedule.
     */
    virtual std::string GetScheduleName() const override { return "OldGrowLocalAutoCoresParallel"; }
};
