...
void ConstructComputationalDag(const GraphFrom &from, GraphTo &to) {
    static_assert(isComputationalDagV<GraphFrom>, "Graph_from must satisfy the computational_dag concept");
    static_assert(isConstructableCdagVertexV<GraphTo>, "Graph_to must satisfy the constructable_cdag_vertex concept");
