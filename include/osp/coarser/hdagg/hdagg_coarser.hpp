...
class HdaggCoarser : public CoarserGenContractionMap<GraphTIn, GraphTOut> {
    static_assert(isDirectedGraphEdgeDescV<GraphTIn>, "Graph_t_in must satisfy the directed_graph edge desc concept");
    static_assert(hasHashableEdgeDescV<GraphTIn>, "Graph_t_in must satisfy the has_hashable_edge_desc concept");
    static_assert(hasTypedVerticesV<GraphTIn>, "Graph_t_in must have typed vertices");
