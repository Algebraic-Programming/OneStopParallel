...
class CompactSparseGraph {
  ...
  public:
    ...
    static bool constexpr verticesInTopOrder = true;
    static bool constexpr childrenInTopOrder = true;
    static bool constexpr childrenInVertexOrder = true;
    static bool constexpr parentsInTopOrder = true;
    static bool constexpr parentsInVertexOrder = true;
...
static_assert(isDirectConstructableCdagV<CompactSparseGraph<true, true>>, "Compact_Sparse_Graph must be directly constructable");

static_assert(isDirectConstructableCdagV<CompactSparseGraph<false, true>>, "Compact_Sparse_Graph must be directly constructable");
