...
struct SMGreedyBspGrowLocalAutoCores_Params {
 ...
 */
class SMGreedyBspGrowLocalAutoCoresParallel{
  ...
  public:
     ...
     */
    SMGreedyBspGrowLocalAutoCoresParallel(SMGreedyBspGrowLocalAutoCores_Params params_ = SMGreedyBspGrowLocalAutoCores_Params()) : params(params_) {}

    /**
     * @brief Default destructor for GreedyBspScheduler.
     */
    virtual ~SMGreedyBspGrowLocalAutoCoresParallel() = default;
    ...
    void computePartialSchedule(const SmInstance &instance, unsigned *const node_to_proc, unsigned *const node_to_supstep,  const unsigned int startNode, const unsigned int endNode, unsigned &supstep) const;    
     ...
     *
     * This method returns the name of the schedule, which is "SMGreedyBspGrowLocalAutoCoresParallel" in this case.
     *
     * @return The name of the schedule.
     */
    virtual std::string getScheduleName() const {

        return "SMGreedyBspGrowLocalAutoCoresParallel";
    }
