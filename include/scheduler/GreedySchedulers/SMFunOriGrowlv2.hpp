...
struct SMFunOriGrowlv2_Params {
  // Funnel
  double maxWeightMedianMultiplier = 20.0;
...
class SMFunOriGrowlv2 {
  ...
  public:
     ...
     */
    SMFunOriGrowlv2(SMFunOriGrowlv2_Params params_ = SMFunOriGrowlv2_Params()) : params(params_) {}

    /**
     * @brief Default destructor for GreedyBspScheduler.
     */
    virtual ~SMFunOriGrowlv2() = default;
     ...
     *
     * This method returns the name of the schedule, which is "SMFunOriGrowlv2" in this case.
     *
     * @return The name of the schedule.
     */
    virtual std::string getScheduleName() const {

        return "SMFunOriGrowlv2";
    }
