 ...
 */
class GreedyBspGrowLocal : public Scheduler {
  ...
  public:
     ...
     */
    virtual ~GreedyBspGrowLocal() = default;
    ...
    std::pair<RETURN_STATUS, BspSchedule> computeSchedule_csr(const BspInstance_csr &instance_csr, const BspInstance &instance);
