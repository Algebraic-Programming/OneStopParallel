...
struct ConfigParser {
  ...
  private:
    ...
    void ParseConfigFile(std::string filename) {
        ...
        globalParams = loadPtreeRoot.get_child("globalParameters");
                ...
                for (int i = 1; i < argc; ++i) {
                    ...
                    if (std::string(flag) == "--config") {
                        ...
                        machineSpecified = true;
                               ...
                               || std::string(flag) == "-o") {
                        globalParams.put("outputSchedule", true);
                    } else {
                        AddAlgorithm(flag);
                    }
                }
