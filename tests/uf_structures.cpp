...
BOOST_AUTO_TEST_CASE(Union_find_structure1) {
    ...
    Union_Find_Universe<std::string> test_universe(names);
...
BOOST_AUTO_TEST_CASE(Union_find_structure2) {
    ...
    Union_Find_Universe<std::string> test_universe;
...
BOOST_AUTO_TEST_CASE(Union_find_weight_structure) {
    ...
    std::vector<unsigned> weights_mismatch({1, 2, 1, 3, 1, 1, 1});

    BOOST_CHECK_THROW(Union_Find_Universe<std::string> test_universe(names, weights_mismatch), std::runtime_error);
    Union_Find_Universe<std::string> test_universe(names, weights, weights);
