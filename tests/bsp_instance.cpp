...
BOOST_AUTO_TEST_CASE(Test1) {
    BspArchitecture<ComputationalDagVectorImplDefT> architecture(4, 2, 3);
    ...
    BspArchitecture<ComputationalDagVectorImplDefT> architecture2(6, 3, 1);
...
BOOST_AUTO_TEST_CASE(TestInstanceBicgstab) {
    ...
    BspInstance<ComputationalDagVectorImplDefT> instanceT2(instance);
    ...
    BOOST_CHECK_EQUAL(instanceT2.GetComputationalDag().num_edges(), instance.GetComputationalDag().NumEdges());
