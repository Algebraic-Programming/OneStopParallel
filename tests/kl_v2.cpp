...
BOOST_AUTO_TEST_CASE(kl_base_1) {
    ...
    BOOST_CHECK_EQUAL(affinity[v1][0][1], 2.0 - 4.5);
    BOOST_CHECK_EQUAL(affinity[v1][1][1], 0.0);
    BOOST_CHECK_EQUAL(affinity[v2][0][1], 3.5);

    BOOST_CHECK_EQUAL(affinity[v2][0][0], std::numeric_limits<double>::lowest());
    BOOST_CHECK_EQUAL(affinity[v2][1][0], std::numeric_limits<double>::lowest());
    BOOST_CHECK_EQUAL(affinity[v2][0][2], std::numeric_limits<double>::lowest());
    BOOST_CHECK_EQUAL(affinity[v2][1][2], std::numeric_limits<double>::lowest());
...
BOOST_AUTO_TEST_CASE(kl_base_2) {
    ...
    BOOST_CHECK_EQUAL(affinity[v1][0][0], std::numeric_limits<double>::lowest());
    BOOST_CHECK_EQUAL(affinity[v1][0][1], -4.5);
    BOOST_CHECK_EQUAL(affinity[v1][0][2], -2.5);
    BOOST_CHECK_EQUAL(affinity[v1][1][0], std::numeric_limits<double>::lowest());
    BOOST_CHECK_EQUAL(affinity[v1][1][1], 2.0);
    BOOST_CHECK_EQUAL(affinity[v1][1][2], 0.0); 

    BOOST_CHECK_EQUAL(affinity[v2][0][0], std::numeric_limits<double>::lowest());
    BOOST_CHECK_EQUAL(affinity[v2][0][1], 9.5);
    BOOST_CHECK_EQUAL(affinity[v2][0][2], 11.5);
    BOOST_CHECK_EQUAL(affinity[v2][1][0], std::numeric_limits<double>::lowest());
    BOOST_CHECK_EQUAL(affinity[v2][1][1], 3.0);
    BOOST_CHECK_EQUAL(affinity[v2][1][2], 0.0);

    BOOST_CHECK_EQUAL(affinity[v3][0][0], 0.0);
    BOOST_CHECK_EQUAL(affinity[v3][0][1], 4.0);
    BOOST_CHECK_EQUAL(affinity[v3][0][2], 4.0);
    BOOST_CHECK_EQUAL(affinity[v3][1][0], -0.5);
    BOOST_CHECK_EQUAL(affinity[v3][1][1], -4.5);
    BOOST_CHECK_EQUAL(affinity[v3][1][2], -1.5);

    BOOST_CHECK_EQUAL(affinity[v4][0][0], 0.0);
    ...
    BOOST_CHECK_EQUAL(affinity[v5][0][0], 9.0);
    BOOST_CHECK_EQUAL(affinity[v5][0][1], 9.0);
    BOOST_CHECK_EQUAL(affinity[v5][0][2], 8.0);
    BOOST_CHECK_EQUAL(affinity[v5][1][0], 0.0);
    BOOST_CHECK_EQUAL(affinity[v5][1][1], 0.0);
    BOOST_CHECK_EQUAL(affinity[v5][1][2], 6.0);

    BOOST_CHECK_EQUAL(affinity[v6][0][0], 7.0);
    BOOST_CHECK_EQUAL(affinity[v6][0][1], 1.0);
    BOOST_CHECK_EQUAL(affinity[v6][0][2], 6.0);
    BOOST_CHECK_EQUAL(affinity[v6][1][0], 3.5);
    BOOST_CHECK_EQUAL(affinity[v6][1][1], 10.5);
    BOOST_CHECK_EQUAL(affinity[v6][1][2], 10.5);

    BOOST_CHECK_EQUAL(affinity[v7][0][0], 8.0);
    BOOST_CHECK_EQUAL(affinity[v7][0][1], 0.0);
    BOOST_CHECK_EQUAL(affinity[v7][0][2], std::numeric_limits<double>::lowest());
    BOOST_CHECK_EQUAL(affinity[v7][1][0], 7.0);
    BOOST_CHECK_EQUAL(affinity[v7][1][1], 8.0);
    BOOST_CHECK_EQUAL(affinity[v7][1][2], std::numeric_limits<double>::lowest());

    BOOST_CHECK_EQUAL(affinity[v8][0][0], 8.5);
    BOOST_CHECK_EQUAL(affinity[v8][0][1], 8.5);
    BOOST_CHECK_EQUAL(affinity[v8][0][2], std::numeric_limits<double>::lowest());
    BOOST_CHECK_EQUAL(affinity[v8][1][0], 8.0);
    BOOST_CHECK_EQUAL(affinity[v8][1][1], 1.0);
    BOOST_CHECK_EQUAL(affinity[v8][1][2], std::numeric_limits<double>::lowest());
...
BOOST_AUTO_TEST_CASE(kl_base_3) {
    ...
    BOOST_CHECK_EQUAL(affinity[v1][0][0], std::numeric_limits<double>::lowest());
    BOOST_CHECK_EQUAL(affinity[v1][0][1], 4.5);
    BOOST_CHECK_EQUAL(affinity[v1][0][2], 6.5);
    BOOST_CHECK_EQUAL(affinity[v1][1][0], std::numeric_limits<double>::lowest());
    BOOST_CHECK_EQUAL(affinity[v1][1][1], 2.0);
    BOOST_CHECK_EQUAL(affinity[v1][1][2], 27.0); 

    BOOST_CHECK_EQUAL(affinity[v2][0][0], std::numeric_limits<double>::lowest());
    BOOST_CHECK_EQUAL(affinity[v2][0][1], 18.5);
    BOOST_CHECK_EQUAL(affinity[v2][0][2], 11.5);
    BOOST_CHECK_EQUAL(affinity[v2][1][0], std::numeric_limits<double>::lowest());
    BOOST_CHECK_EQUAL(affinity[v2][1][1], 3.0);
    BOOST_CHECK_EQUAL(affinity[v2][1][2], 0.0);

    BOOST_CHECK_EQUAL(affinity[v3][0][0], 9.0);
    BOOST_CHECK_EQUAL(affinity[v3][0][1], 4.0);
    BOOST_CHECK_EQUAL(affinity[v3][0][2], 13.0);
    BOOST_CHECK_EQUAL(affinity[v3][1][0], -0.5);
    BOOST_CHECK_EQUAL(affinity[v3][1][1], -4.5);
    BOOST_CHECK_EQUAL(affinity[v3][1][2], 7.5);

    BOOST_CHECK_EQUAL(affinity[v4][0][0], 9.0);
    BOOST_CHECK_EQUAL(affinity[v4][0][1], 5.0);
    BOOST_CHECK_EQUAL(affinity[v4][0][2], 5.0);
    BOOST_CHECK_EQUAL(affinity[v4][1][0], -2.5);
    BOOST_CHECK_EQUAL(affinity[v4][1][1], -6.5);
    ...
    BOOST_CHECK_EQUAL(affinity[v5][0][0], 9.0);
    BOOST_CHECK_EQUAL(affinity[v5][0][1], 9.0);
    BOOST_CHECK_EQUAL(affinity[v5][0][2], 17.0);
    BOOST_CHECK_EQUAL(affinity[v5][1][0], 9.0);
    BOOST_CHECK_EQUAL(affinity[v5][1][1], 0.0);
    BOOST_CHECK_EQUAL(affinity[v5][1][2], 6.0);
    ...
    BOOST_CHECK_EQUAL(affinity[v6][0][1], 1.0);
    BOOST_CHECK_EQUAL(affinity[v6][0][2], 6.0);
    BOOST_CHECK_EQUAL(affinity[v6][1][0], 12.5);
    BOOST_CHECK_EQUAL(affinity[v6][1][1], 10.5);
    BOOST_CHECK_EQUAL(affinity[v6][1][2], 10.5);
    ...
    BOOST_CHECK_EQUAL(affinity[v8][0][0], 17.5);
    BOOST_CHECK_EQUAL(affinity[v8][0][1], 8.5);
    BOOST_CHECK_EQUAL(affinity[v8][0][2], std::numeric_limits<double>::lowest());
    BOOST_CHECK_EQUAL(affinity[v8][1][0], 8.0);
    BOOST_CHECK_EQUAL(affinity[v8][1][1], 1.0);
    ...
    for ( auto i : nodes) {
        for (size_t j = 0; j < table_1[i].size(); ++j) {
            for (size_t k = 0; k < table_1[i][j].size(); ++k) {
                BOOST_CHECK_EQUAL(table_1[i][j][k], table_2[i][j][k]);

                if (table_1[i][j][k] != table_2[i][j][k]) {
...
BOOST_AUTO_TEST_CASE(kl_base_6) {
    ...
    // BOOST_CHECK_EQUAL(affinity[v3][0][1], 4.0);
    // BOOST_CHECK_EQUAL(affinity[v3][0][2], 4.0);
    // BOOST_CHECK_EQUAL(affinity[v3][1][0], 4.0);
    // BOOST_CHECK_EQUAL(affinity[v3][1][1], 0.0);
    // BOOST_CHECK_EQUAL(affinity[v3][1][2], 3.0);

    // BOOST_CHECK_EQUAL(affinity[v4][0][0], 0.0);
    // BOOST_CHECK_EQUAL(affinity[v4][0][1], 5.0);
    // BOOST_CHECK_EQUAL(affinity[v4][0][2], 5.0);
    // BOOST_CHECK_EQUAL(affinity[v4][1][0], 5.0);
    // BOOST_CHECK_EQUAL(affinity[v4][1][1], 1.0);
    // BOOST_CHECK_EQUAL(affinity[v4][1][2], 4.0);
