...
int main(int argc, char* argv[]) {
    ...
    // Set up architecture
    instance.getArchitecture().set_processors_consequ_types({128,48},{100,100});
    instance.setDiagonalCompatibilityMatrix(2);
    instance.setSynchronisationCosts(4000);
    ...
    iso_scheduler.setMinSymmetry(4);
    iso_scheduler.setMergeDifferentTypes(false);
    iso_scheduler.setWorkThreshold(200);
    iso_scheduler.setCriticalPathThreshold(400);
    iso_scheduler.setOrbitLockRatio(0.3);
