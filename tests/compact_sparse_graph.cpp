...
BOOST_AUTO_TEST_CASE(NoEdgesGraphReorder) {
    ...
    const std::vector<std::size_t> &graphPerm = graph.get_pullback_permutation();
...
BOOST_AUTO_TEST_CASE(Graph1KeepOrder) {
    ...
    BOOST_CHECK_EQUAL(graph.num_vertices(), cntr0);
...
BOOST_AUTO_TEST_CASE(Graph1CopyKeepOrder) {
    ...
    Compact_Sparse_Graph<true> graph(11, edges);
    Compact_Sparse_Graph<true> copyGraph(graph);

    BOOST_CHECK_EQUAL(copyGraph.num_vertices(), 11);
    BOOST_CHECK_EQUAL(copyGraph.num_edges(), 11);
    ...
    BOOST_CHECK_EQUAL(copyGraph.num_vertices(), cntr0);
...
BOOST_AUTO_TEST_CASE(Graph1MoveKeepOrder) {
    ...
    Compact_Sparse_Graph<true> graph(11, edges);
    Compact_Sparse_Graph<true> copyGraph(std::move(graph));
...
BOOST_AUTO_TEST_CASE(Graph1CopyReorder) {
    ...
    Compact_Sparse_Graph<false> oriGraph(11, edges);
    Compact_Sparse_Graph<false> graph(oriGraph);
...
BOOST_AUTO_TEST_CASE(Graph1MoveReorder) {
    ...
    Compact_Sparse_Graph<false> oriGraph(11, edges);
    Compact_Sparse_Graph<false> graph(std::move(oriGraph));
