...
//     BOOST_CHECK_EQUAL(affinity[v1][0][0], std::numeric_limits<double>::lowest());
//     BOOST_CHECK_EQUAL(affinity[v1][0][1], 1.0);
//     BOOST_CHECK_EQUAL(affinity[v1][0][2], 3.0);
//     BOOST_CHECK_EQUAL(affinity[v1][1][0], std::numeric_limits<double>::lowest());
//     BOOST_CHECK_EQUAL(affinity[v1][1][1], 2.0);
//     BOOST_CHECK_EQUAL(affinity[v1][1][2], 16.5); 

//     BOOST_CHECK_EQUAL(affinity[v2][0][0], std::numeric_limits<double>::lowest());
//     BOOST_CHECK_EQUAL(affinity[v2][0][1], 15);
//     BOOST_CHECK_EQUAL(affinity[v2][0][2], 11.5);
//     BOOST_CHECK_EQUAL(affinity[v2][1][0], std::numeric_limits<double>::lowest());
//     BOOST_CHECK_EQUAL(affinity[v2][1][1], 3.0);
//     BOOST_CHECK_EQUAL(affinity[v2][1][2], 0.0);
...
//     BOOST_CHECK_EQUAL(affinity[v3][1][0], -0.5);
//     BOOST_CHECK_EQUAL(affinity[v3][1][1], -4.5);
//     BOOST_CHECK_EQUAL(affinity[v3][1][2], 4);
...
//     BOOST_CHECK_EQUAL(affinity[v5][0][0], 9.0);
//     BOOST_CHECK_EQUAL(affinity[v5][0][1], 9.0);
//     BOOST_CHECK_EQUAL(affinity[v5][0][2], 13.5);
//     BOOST_CHECK_EQUAL(affinity[v5][1][0], 5.5);
//     BOOST_CHECK_EQUAL(affinity[v5][1][1], 0.0);
//     BOOST_CHECK_EQUAL(affinity[v5][1][2], 6.0);
...
//     BOOST_CHECK_EQUAL(affinity[v6][0][1], 1.0);
//     BOOST_CHECK_EQUAL(affinity[v6][0][2], 6.0);
//     BOOST_CHECK_EQUAL(affinity[v6][1][0], 9.0);
//     BOOST_CHECK_EQUAL(affinity[v6][1][1], 10.5);
//     BOOST_CHECK_EQUAL(affinity[v6][1][2], 10.5);
...
//     BOOST_CHECK_EQUAL(affinity[v8][0][0], 14.0);
//     BOOST_CHECK_EQUAL(affinity[v8][0][1], 8.5);
//     BOOST_CHECK_EQUAL(affinity[v8][0][2], std::numeric_limits<double>::lowest());
//     BOOST_CHECK_EQUAL(affinity[v8][1][0], 8.0);
//     BOOST_CHECK_EQUAL(affinity[v8][1][1], 1.0);
