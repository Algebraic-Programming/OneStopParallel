...
bool ValidateAffinityTables(kl_improver_test<GraphT, CommCostFunctionT, MemoryConstraintT, WindowSize, CostT> &klIncremental,
    ...
    kl_improver_test<GraphT, CommCostFunctionT, MemoryConstraintT, WindowSize, CostT> klFresh;
